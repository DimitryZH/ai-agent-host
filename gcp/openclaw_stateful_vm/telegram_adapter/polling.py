"""Disabled poll-once coordinator for Telegram-like adapter tests.

This module models one polling cycle only. It does not provide a polling loop,
sleep/retry behavior, service integration, or runtime wiring.
"""
...
from gcp.openclaw_stateful_vm.telegram_adapter.telegram_client import TelegramApiError
...
class TelegramPollClient(Protocol):
    """Minimal client surface needed for one disabled poll cycle."""
...
class PollOnceResult:
    """Safe result for one disabled poll cycle."""
