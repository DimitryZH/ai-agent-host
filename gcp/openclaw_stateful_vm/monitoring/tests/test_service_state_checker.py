...
class ServiceStateCheckerTests(unittest.TestCase):
    ...
    def test_metrics_json_multiple_services_have_bounded_metrics_and_labels(self) -> None:
        states = [
            ...
            checker.ServiceState(
                ...
                properties=checker.parse_systemctl_show(
                    systemctl_output("openclaw-telegram-adapter.service")
                ),
            ),
        ]
        ...
        self.assertEqual(
            ...
            ["openclaw-telegram-adapter.service", "openclaw.service"],
        )
        for metric in payload["metrics"]:
    ...
    def test_metrics_json_excludes_timestamps_raw_output_and_sensitive_strings(self) -> None:
        state = checker.ServiceState(
            ...
            properties=checker.parse_systemctl_show(
                ...
                + "\nExecStart=/bin/command --token secret"
                + "\nStatusText=telegram payload text"
        ...
        self.assertNotIn("telegram payload text", serialized)
