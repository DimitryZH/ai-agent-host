...
from gcp.openclaw_stateful_vm.monitoring import service_state_monitor_runner as runner
...
def healthy_states() -> list[checker.ServiceState]:
    return [
        ...
        service_state("openclaw-telegram-adapter.service"),
    ]
...
class ServiceStateMonitorRunnerTests(unittest.TestCase):
    def test_runner_returns_zero_when_both_services_are_healthy(self) -> None:
        ...
        self.assertEqual(len(model["time_series"]), 8)
