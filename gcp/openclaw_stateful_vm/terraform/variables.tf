variable "project_id" {
  description = "GCP project ID where the OpenClaw stateful VM resources will be created."
  type        = string
}
...
variable "name_prefix" {
  description = "RFC1035-compatible prefix used for OpenClaw stateful VM resources."
  type        = string
...
variable "openclaw_uid" {
  description = "OpenClaw container runtime UID, matching the validated Cloud Run image."
  type        = number
  default     = 10001
}

variable "openclaw_gid" {
  description = "OpenClaw container runtime GID, matching the validated Cloud Run image."
  type        = number
  default     = 10001
}

variable "openclaw_port" {
  description = "OpenClaw gateway port, preserving the validated Cloud Run container contract."
  type        = number
  default     = 8080
...
variable "install_ops_agent" {
  description = "Install the Google Cloud Ops Agent during bootstrap."
  type        = bool
  default     = true
}
